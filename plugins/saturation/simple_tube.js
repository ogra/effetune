class SimpleTubePlugin extends PluginBase {
    constructor() {
        super('Simple Tube', 'Tube saturation effect with drive and bias control');
    ...
    createUI() {
        ...
        container.className = 'simple-tube-plugin-ui plugin-parameter-ui';
...
// Register the plugin
window.SimpleTubePlugin = SimpleTubePlugin;
