...
| EQ | Hi Pass Filter | Удаляет нежелательные низкие частоты с точностью | [Детали](plugins/eq.md#hi-pass-filter) |
| EQ | Lo Pass Filter | Удаляет нежелательные высокие частоты с точностью | [Детали](plugins/eq.md#lo-pass-filter) |
...
| EQ         | Tilt EQ               | Наклонный эквалайзер для быстрой настройки тембра                  | [Подробнее](plugins/eq.md#tilt-eq)                         |
| EQ         | Tone Control          | Трехполосный регулятор тембра                                      | [Подробнее](plugins/eq.md#tone-control)                    |
...
| Modulation | Doppler Distortion | Имитация естественных, динамических изменений звука, вызванных незначительным движением конуса динамика | [Детали](plugins/modulation.md#doppler-distortion) |
...
| Resonator | Modal Resonator | Эффект частотного резонанса с возможностью использования до 5 резонаторов | [Подробнее](plugins/resonator.md#modal-resonator) |
...
| Saturation | Harmonic Distortion | Добавляет уникальный характер за счет гармонического искажения с независимым контролем каждой гармоники | [Детали](plugins/saturation.md#harmonic-distortion) |
