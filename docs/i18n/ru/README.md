...
| Saturation | Intermodulator | Добавляет уникальный характер за счет гармонического интермодуляционного искажения | [Детали](plugins/saturation.md#intermodulator) |
