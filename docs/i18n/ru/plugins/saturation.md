...
- [Intermodulator](#intermodulator) - Добавляет уникальный характер посредством гармонических интермодуляционных искажений 

## Intermodulator

Плагин Intermodulator представляет эффект гармонических интермодуляционных искажений, который выходит за рамки традиционной насыщенности. Целенаправленным введением управляемых гармонических компонентов он создает сложные взаимодействия, обогащающие ваш звук новыми текстурами и динамичным характером.
...
- **2nd Harm (%):** Управляет количеством добавляемой второй гармоники (0–30%, по умолчанию: 2%)
  - Низкие значения создают нежное тепло, в то время как высокие значения отчетливо подчеркивают вторую гармонику.

- **3rd Harm (%):** Регулирует вклад третьей гармоники (0–30%, по умолчанию: 3%)
  - Повышает ясность и добавляет яркость, придавая звуку более живой характер.

- **4th Harm (%):** Изменяет интенсивность четвертой гармоники (0–30%, по умолчанию: 0.5%)
  - Вносит тонкие детали в общий гармонический профиль.

- **5th Harm (%):** Устанавливает уровень пятой гармоники (0–30%, по умолчанию: 0.3%)
  - Добавляет утонченную сложность, способствуя созданию многослойного, текстурированного тона.

- **Sensitivity (x):** Регулирует общую чувствительность входного сигнала (0.1–2.0, по умолчанию: 0.5)
  - Низкая чувствительность обеспечивает более сдержанный эффект, в то время как высокая увеличивает интенсивность искажений.
