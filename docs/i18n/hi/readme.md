...
2. कॉन्फ़िगरेशन:
   - ब्राउज़र में EffeTune खोलें
   - ब्राउज़र में इनपुट स्रोत के रूप में वर्चुअल ऑडियो डिवाइस चुनें
...
1. कॉन्फ़िगरेशन:
   ...
   - ब्राउज़र में EffeTune खोलें
   - ब्राउज़र में इनपुट स्रोत के रूप में अपने ऑडियो इंटरफ़ेस का चयन करें
...
1. अपने Effect Chain को सहेजें:
   ...
   - प्रीसेट इनपुट फील्ड में एक नाम दर्ज करें
...
2. कीबोर्ड शॉर्टकट्स:
   - Ctrl + A: पाइपलाइन में सभी इफेक्ट्स चुनें
   - Ctrl + C: चयनित इफेक्ट्स कॉपी करें
   - Ctrl + V: क्लिपबोर्ड से इफेक्ट्स पेस्ट करें
   - Ctrl + F: इफेक्ट्स के लिए सर्च करें
   - Ctrl + S: वर्तमान पाइपलाइन सहेजें
   - Ctrl + Shift + S: वर्तमान पाइपलाइन को save करें
...
3. डाउनलोड विकल्प:
   - एकल फ़ाइलों को WAV फ़ॉर्मेट में डाउनलोड किया जाता है
...
4. सभी इफेक्ट सेटिंग्स URL में संग्रहीत होती हैं, जिससे उन्हें सहेजना और साझा करना आसान हो जाता है

### ऑडियो रिसेट

यदि आपको ऑडियो समस्याओं (ड्रॉपआउट्स, ग्लिचेस) का अनुभव होता है:
1. ऊपर-बाएँ कोने में "Reset Audio" बटन पर क्लिक करें
...
1. ड्रॉपआउट्स या ग्लिचेस  
   - "Reset Audio" पर क्लिक करके ऑडियो पाइपलाइन पुनर्निर्मित करें  
...
1. कोई ऑडियो इनपुट नहीं  
   - ब्राउज़र में इनपुट डिवाइस चयन की जाँच करें  
   - ब्राउज़र माइक्रोफोन अनुमतियों की पुष्टि करें  
   - सुनिश्चित करें कि आपके स्रोत से ऑडियो प्ले हो रहा है

2. इफेक्ट काम नहीं कर रहा  
   - सत्यापित करें कि इफेक्ट सक्षम है (ON/OFF बटन)  
   - पैरामीटर सेटिंग्स की जाँच करें  
   - इफेक्ट को हटाकर फिर से जोड़ने का प्रयास करें

3. साझा करने की समस्याएँ  
   - URL जनरेट करने के लिए "Share" बटन का उपयोग करें  
   - साझा करते समय पूरे URL को कॉपी करें  
   - नए ब्राउज़र विंडो में साझा लिंक का परीक्षण करें
...
**प्रश्न:** क्या मैं अपने पसंदीदा इफेक्ट संयोजनों को सहेज सकता हूँ?  
**उत्तर:** हाँ! "Share" बटन का उपयोग करके एक URL जनरेट करें जिसमें आपकी पूरी इफेक्ट चेन कॉन्फ़िगरेशन शामिल हो। इस URL को बुकमार्क करें ताकि आपकी सेटिंग्स सहेजी जा सकें।
