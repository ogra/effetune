...
モジュレーション・エフェクトを用いて、音楽に動きと変化を与えるプラグインのコレクションです。これらのエフェクトは、デジタル音楽によりオーガニックでダイナミックな感覚をもたらし、微妙または劇的な音のバリエーションでリスニング体験を向上させます。

## プラグイン一覧

- [Tremolo](#tremolo) - パルス状でダイナミックなサウンドのためのリズミカルな音量変動を生み出します
- [Wow Flutter](#wow-flutter) - ビニールレコードやテーププレーヤーの柔らかなピッチ変動を再現します
