...
### إعداد مشغل ملفات الموسيقى (تطبيق سطح المكتب فقط)

- قم بتثبيت وتشغيل تطبيق EffeTune لسطح المكتب
- افتح وشغل ملف موسيقى للتأكد من التشغيل الصحيح
   - افتح ملف موسيقى واختر EffeTune كتطبيق
   - أو اختر فتح ملف موسيقى... من قائمة الملف
