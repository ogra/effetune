...
- [Loudness Equalizer](#loudness-equalizer) - تصحيح توازن التردد للاستماع بمستوى صوت منخفض
...
معادل متخصص يضبط توازن الترددات تلقائياً بناءً على مستوى صوت الاستماع. تعوض هذه الإضافة عن انخفاض حساسية الأذن البشرية للترددات المنخفضة والعالية عند مستويات الصوت المنخفضة، مما يضمن تجربة استماع متناسقة وممتعة بغض النظر عن مستوى التشغيل.

### دليل تحسين الاستماع
- الاستماع بمستوى صوت منخفض:
  - تعزيز للترددات المنخفضة والعالية
  - الحفاظ على التوازن الموسيقي عند المستويات الهادئة
  - تعويض خصائص السمع البشري
- المعالجة المعتمدة على مستوى الصوت:
  - تعزيز أكبر عند مستويات الصوت المنخفضة
  - تقليل تدريجي للمعالجة مع زيادة مستوى الصوت
  - صوت طبيعي عند مستويات الاستماع العالية
- توازن الترددات:
  - رف منخفض لتعزيز الباس (100-300 هرتز)
  - رف عالٍ لتعزيز الطنين (3-6 كيلوهرتز)
  - انتقال سلس بين نطاقات التردد

### Parameters
- **Average SPL** - مستوى الاستماع الحالي (60 إلى 85 ديسيبل)
  - القيم الأقل: تعزيز أكبر
  - القيم الأعلى: تعزيز أقل
  - يمثل مستوى الاستماع النموذجي
- **تحكمات التردد المنخفض**
  - التردد: مركز تعزيز الباس (100 إلى 300 هرتز)
  - الكسب: تعزيز الباس الأقصى (0 إلى 15 ديسيبل)
  - Q: شكل تعزيز الباس (0.5 إلى 1.0)
- **تحكمات التردد العالي**
  - التردد: مركز تعزيز الطنين (3 إلى 6 كيلوهرتز)
  - الكسب: تعزيز الطنين الأقصى (0 إلى 15 ديسيبل)
  - Q: شكل تعزيز الطنين (0.5 إلى 1.0)

### العرض المرئي
- رسم بياني لاستجابة التردد في الوقت الفعلي
- تحكمات معلمات تفاعلية
- تصور منحنى معتمد على مستوى الصوت
- قراءات رقمية دقيقة
