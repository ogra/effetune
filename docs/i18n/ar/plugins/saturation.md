...
- [Intermodulator](#intermodulator) - يضيف طابعًا فريدًا عبر تشويه التداخل التوافقي
...
يقوم مكون Intermodulator بإدخال تأثير تشويه التداخل التوافقي يتجاوز التشبع التقليدي. من خلال حقن مكونات تآثرية مضبوطة بشكل متعمد، فإنه يخلق تفاعلات معقدة تثري صوتك بأنسجة جديدة وطابع ديناميكي.
...
### المعلمات
- **2nd Harm (%):** يتحكم في كمية التوافقي الثاني المضافة (0–30%, default: 2%)
  - القيم الأدنى تعطي دفء رقيقًا، بينما القيم الأعلى تبرز التوافقي الثاني بوضوح.
- **3rd Harm (%):** يعدل مساهمة التوافقي الثالث (0–30%, default: 3%)
  - يعزز الوضوح ويضيف إشراقًا، مما يمنح الصوت طابعًا أكثر حيوية.
- **4th Harm (%):** يعدل شدة التوافقي الرابع (0–30%, default: 0.5%)
  - يضفي تفاصيل دقيقة على الملف التوافقي العام.
- **5th Harm (%):** يحدد مستوى التوافقي الخامس (0–30%, default: 0.3%)
  - يضيف تعقيداً دقيقاً، مساهماً في تكوين نغمة متعددة الطبقات وذات نسيج غني.
- **Sensitivity (x):** يعدل حساسية الإدخال العامة (0.1–2.0, default: 0.5)
  - الحساسية المنخفضة توفر تأثيرًا أكثر تحفظًا، بينما الحساسية العالية تزيد من شدة التشويه.
