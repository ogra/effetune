...
모듈레이션 이펙트를 통해 음악에 움직임과 변화를 더하는 플러그인 모음입니다. 이 이펙트들은 디지털 음악을 보다 자연스럽고 역동적으로 만들어 미묘하거나 극적인 소리의 변화를 통해 청취 경험을 향상시킵니다.
  
## 플러그인 목록

- [Tremolo](#tremolo) - 맥동하는 역동적인 사운드를 위해 리드믹한 볼륨 변화를 생성합니다
- [Wow Flutter](#wow-flutter) - 바이닐 레코드와 테이프 플레이어의 부드러운 피치 변화를 재현합니다
