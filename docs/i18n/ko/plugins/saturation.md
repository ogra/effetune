...
- [Intermodulator](#intermodulator) - 고조파 간섭 왜곡을 통해 독특한 개성을 부여합니다
...
Intermodulator 플러그인은 전통적인 포화 효과를 넘어선 고조파 간섭 왜곡 효과를 선보입니다. 제어된 고조파 성분을 의도적으로 주입하여 복잡한 상호 작용을 만들어내며 사운드에 새로운 질감과 다이내믹한 캐릭터를 부여합니다.
...
### 파라미터
- **2nd Harm (%):** 두 번째 고조파 추가량을 조절합니다 (0–30%, default: 2%)
  - 낮은 값은 은은한 따뜻함을 제공하고, 높은 값은 두 번째 고조파를 뚜렷하게 강조합니다.
- **3rd Harm (%):** 세 번째 고조파의 기여도를 조절합니다 (0–30%, default: 3%)
  - 선명도를 높이고 밝음을 더해 사운드에 더욱 생동감 있는 캐릭터를 부여합니다.
- **4th Harm (%):** 네 번째 고조파의 강도를 조절합니다 (0–30%, default: 0.5%)
  - 전체 고조파 프로필에 섬세한 디테일을 추가합니다.
- **5th Harm (%):** 다섯 번째 고조파의 수준을 설정합니다 (0–30%, default: 0.3%)
  - 섬세한 복잡성을 더해 층진 질감의 톤을 구현합니다.
- **Sensitivity (x):** 전반적인 입력 민감도를 조절합니다 (0.1–2.0, default: 0.5)
  - 낮은 민감도는 보다 미묘한 효과를, 높은 민감도는 왜곡 강도를 증가시킵니다.
